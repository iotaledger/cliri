...
```docker run iotaledger/cliri:v0.2.1 -p 14265```
...
```docker run -v /path/to/conf:/iri/conf -v /path/to/data:/iri/data iotaledger/cliri:v0.2.1 -p 14265 -c /iri/conf/iri.ini```
